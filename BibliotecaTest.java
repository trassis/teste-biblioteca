...
public class BibliotecaTest {
  ...
  // Novo teste implementado por mim.
  @Test          
  public void testaLivrosEmprestadosUsuario() throws ExcecaoLivroEmprestado{
    bib.emprestarLivro(livro1, usuario1);    
    bib.emprestarLivro(livro2, usuario1);    

    List<Livro> emprestadosUsuario = bib.livrosEmprestadosUsuario(usuario1);
    assertEquals(emprestadosUsuario.get(0), livro1);
    assertEquals(emprestadosUsuario.get(1), livro2);
  }
}
